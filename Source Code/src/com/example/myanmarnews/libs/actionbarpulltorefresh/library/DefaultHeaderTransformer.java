...
import com.example.myanmarnews.libs.actionbarpulltorefresh.library.sdk.Compat;
import com.example.myanmarnews.libs.smoothprogressbar.SmoothProgressBar;
import com.example.myanmarnews.libs.smoothprogressbar.SmoothProgressDrawable;
...
public class DefaultHeaderTransformer extends HeaderTransformer {
	...
	protected DefaultHeaderTransformer(Options options) {
		...
		mReleaseLabel = options.releaseText;
		mProgressBarStyle = options.progressBarStyle;
