...
public class PullToRefreshAttacher {
    ...
    protected PullToRefreshAttacher(Activity activity, Options options) {
        ...
        mHeaderTransformer = options.headerTransformer != null
                ...
                : createDefaultHeaderTransformer(options);
    ...
    protected HeaderTransformer createDefaultHeaderTransformer(Options options) {
        return new DefaultHeaderTransformer(options);
    }
