...
//		
		...
		// "a asldkasd asdlkjasldj asldkjasjd aslkdalkjsd qwqw 1212 3lkas asldka1oijd Content "
		...
		protected String doInBackground(String... args) {
			...
			getActivity().runOnUiThread(new Runnable() {
				public void run() {
					...
					// * */
					// RSSDatabaseHandler rssDb = new
					// RSSDatabaseHandler(getActivity());
					...
					// gridNews.performItemClick(gridNews, 0,
					// gridNews.getItemIdAtPosition(0));
				}
			});
			return null;
		}
